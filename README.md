...
![Workflow Diagram](./AI%20Powered%20Support%20Ticket%20Classifier.png)
...
3. **AI Classification (Groq).** The email is classified into Billing, Tech, or Sales, given an urgency score from 1 to 5, and given a suggested reply. Automated notifications, newsletters, and non actionable platform alerts, like hosting or backup notices, are recognized and filtered out rather than treated as real tickets, so a team is never falsely alerted about something that isn't an actual customer inquiry.
...
- `AI-Powered Support Ticket Classifier.json`, the full exportable n8n workflow. Import it directly into your own n8n instance.
- `AI Powered Support Ticket Classifier.png`, a visual diagram of the workflow.
- `README.md`, this file.
...
3. Update the Slack channel IDs and Airtable base and table references to match your own setup.
...
Built by **Muhammad Sami Ullah**, an AI workflow automation specialist focused on n8n based automation for small businesses and startups.
